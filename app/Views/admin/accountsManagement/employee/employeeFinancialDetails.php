                ...
                <div class="card custom_card custom-table-scroll">
                      <div class="card-body" >
                          <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <?php $i=0; foreach ($employee_list as $value) { $i++;?>
                                                 <tr>
                                                     <td><?=$i?></td>
                                                     <td><?=$value->first_name.' '.$value->last_name?></td>
                                                     <td><?=getTotalAssignedToEmp($value->user_id)?></td>
                                                     <td><?=getTotalPaidToEmployee($value->user_id)?></td>
                                                      <td>
                                                        ...
                                                        <div class="dropdown-menu">
                                                             <a class="dropdown-item" href="<?=base_url('Admin/viewEmployeeFinancialDetails/'.$value->user_id)?>">View Details</a>
                                                        </div>
                                                     </div>
                                                    </td>
                                                 </tr>   
