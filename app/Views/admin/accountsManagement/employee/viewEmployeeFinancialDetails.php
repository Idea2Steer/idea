                                ...
                                <div class="row mt-3">
                                      <div class="col-12">
                                        <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><?=getTotalPaidToEmployee($user_info->user_id)?></td>
                         ...
                         <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $i=0; foreach ($all_invoice_info as $value) { $i++;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?=getTotalProjectDetails($value->project_id)->project_title?>
                                          <?php }else{
                                            echo $value->descriptions;  
                                          } ?>  
                                    </td>
                                    <td><?=$value->total_amount?></td> 
                                    <td><a href="<?=base_url('public/upload/invoice_pdf/'.$value->invoice_pdf)?>" download>Download</a></td>
                                    <td>
