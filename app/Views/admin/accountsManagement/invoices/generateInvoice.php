                            ...
                            <div class="row">
                                <div class="col-md-12 col-xl-12" style="text-align: right;">
                                    <div class="dropdown mt-4 mt-sm-0">
                                        ...
                                        <div class="dropdown-menu">
                                           ...
                                           <a class="dropdown-item" href="<?=base_url('Admin/viewAllInvoices')?>">View All Invoice</a>
                                        </div>
                                    </div>
                                </div>      
                            </div>    
                              <div class="row mt-3">
                                 <div class="col-md-12 col-xl-4">
                                      <div class="form-group">
                                        ...
                                        <select class="form-control" id="project_id" name="project_id" onchange="getUserByProjectID(this.value)">
                              ...
                              <div class="row mt-3">
                                 <div class="col-md-12 col-xl-12 text-center">
                                    <input type="hidden" name="invoice_for" id="invoice_for" value="Received"> 
    ...
    <div class="modal-content">
     ...
     <form action="<?=base_url('Admin/saveCustomInvoiceDetails')?>" id="saveCustomInvoiceForm" enctype="multipart/form-data" method="post">
      <div class="modal-body">
         <div class="row mt-3">
                <div class="col-6">
                     <label for="email" class="form-label">Select Client/Contractor:</label>
      ...
      <div class="modal-footer">
        <input type="hidden" name="c_invoice_for" id="c_invoice_for" value="Received"> 
