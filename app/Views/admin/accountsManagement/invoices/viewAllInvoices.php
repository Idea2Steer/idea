...
<div class="main-content">
   <div class="page-content">
      <div class="container-fluid">
               ...
               <div class="page-title-box d-flex align-items-center justify-content-between">
                  <h4 class="mb-0" style="width: 100%;"><?=$title?>
                        <div style="float: right;">
                            <a href="<?=base_url('Admin/generateInvoice')?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Generate Invoice </a>
                        </div>
                  </h4>
               </div>
            </div>
       ...
       <?php } ?>
        <?=$this->include("admin/accountsManagement/invoices/inv_menu"); ?>
          <div class="row">
            <div class="col-12">
                                                    ...
                                                    <td>
                                                        <div class="dropdown mt-4 mt-sm-0">
                                                            ...
                                                            <div class="dropdown-menu">
                                                               ...
                                                               <a class="dropdown-item" href="<?=base_url('Admin/projectInfo/'.$value->project_id)?>">View Project</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
