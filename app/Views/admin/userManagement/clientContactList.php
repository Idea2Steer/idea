                          ...
                          <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <a href="<?=base_url('Admin/editContact/'.$value->user_id)?>" title="Edit Client Info" class="c_action_icons"><i class="fas fa-edit"></i></a>
                                                       <a href="javascript:void(0)" style="color: red;" onclick="deleteContactInformation('<?=$value->user_id?>')" title="Delete Client Info" class="c_action_icons"><i class='fas fa-trash-alt'></i></a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
