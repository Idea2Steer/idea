                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="product-slick">
                                        <div><img src="<?=base_url('public/front_assets/assets/images/pro3/1.jpg');?>" alt=""
                                                class="img-fluid blur-up lazyload image_zoom_cls-0"></div>
                                        <div><img src="<?=base_url('public/front_assets/assets/images/pro3/2.jpg');?>" alt=""
                                                class="img-fluid blur-up lazyload image_zoom_cls-1"></div>
                                        <div><img src="<?=base_url('public/front_assets/assets/images/pro3/27.jpg');?>" alt=""
                                ...
                                <div class="col-lg-6 rtl-text">
                                    <div class="product-right">
                                        <div class="product-count">
                                            <ul>
                                                <li>
                                                    <img src="<?=base_url('public/front_assets/assets/images/fire.gif');?>" class="img-fluid" alt="image">
                                                    <span class="p-counter">37</span>
                                                    <span class="lang">orders in last 24 hours</span>
                                                </li>
                                                <li>
                                                    <img src="<?=base_url('public/front_assets/assets/images/person.gif');?>" class="img-fluid user_img"
                                                        alt="image">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body"><img
                                                                src="<?=base_url('public/front_assets/assets/images/size-chart.jpg');?>" alt=""
                                                                class="img-fluid blur-up lazyload"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="product-count">
                                            <ul>
                                                <li>
                                                    <img src="<?=base_url('public/front_assets/assets/images/icon/truck.png');?>" class="img-fluid"
                                                        alt="image">
            ...
            <div class="row search-product">
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/pro3/33.jpg');?>"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/pro3/34.jpg');?>"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                ...
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/pro3/1.jpg');?>"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/pro3/2.jpg');?>"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i
                ...
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/pro3/27.jpg');?>"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/pro3/28.jpg');?>"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i
                ...
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/pro3/35.jpg');?>"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/pro3/36.jpg');?>"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i
