...
<head>
    ...
    <link rel="icon" href="<?=base_url('public/front_assets/favicon.jpg');?>" type="image/x-icon">
    <link rel="shortcut icon" href="<?=base_url('public/front_assets/favicon.jpg');?>" type="image/x-icon">
    ...
    <!-- Icons -->
    <link rel="stylesheet" type="text/css" href="<?=base_url('public/front_assets/assets/css/vendors/fontawesome.css');?>">

    <!--Slick slider css-->
    <link rel="stylesheet" type="text/css" href="<?=base_url('public/front_assets/assets/css/vendors/slick.css');?>">
    <link rel="stylesheet" type="text/css" href="<?=base_url('public/front_assets/assets/css/vendors/slick-theme.css');?>">

    <!-- Animate icon -->
    <link rel="stylesheet" type="text/css" href="<?=base_url('public/front_assets/assets/css/vendors/animate.css');?>">

    <!-- Themify icon -->
    <link rel="stylesheet" type="text/css" href="<?=base_url('public/front_assets/assets/css/vendors/themify-icons.css');?>">

    <!-- Bootstrap css -->
    <link rel="stylesheet" type="text/css" href="<?=base_url('public/front_assets/assets/css/vendors/bootstrap.css');?>">

    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="<?=base_url('public/front_assets/assets/css/style.css');?>">

</head>

<body class="theme-color-4" style="--theme-deafult: #ff0000;">

    <!-- loader start -->
    <div class="loader_skeleton">
        <header>
            <div class="top-header top-header-dark3 d-none d-sm-block">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                    ...
                    <div class="col-sm-12">
                        <div class="main-menu">
                            <div class="menu-left category-nav-right">
                                <div class="brand-logo" style="padding-top: 0px;padding-bottom: 0px;">
                                    <a href="#"><img src="<?=base_url('public/front_assets/logo1.jpg');?>"  class="img-fluid blur-up lazyload" alt="" width="200px"></a>
                                </div>
        ...
        <div class="container section-b-space section-t-space">
            ...
            <div class="category-tools">
                <div class="category-m row">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 d-md-flex d-none">
                        <div class="category-wrapper pt-0">
                            <div>
                                <div class="img-ldr">
                                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="main-menu">
                        <div class="menu-left category-nav-right">
                            <div class="brand-logo" style="padding-top: 0px;padding-bottom: 0px;">
                                <a href="#"><img src="<?=base_url('public/front_assets/logo1.jpg');?>"
                                        class="img-fluid blur-up lazyload" alt="" width="200px"></a>
                            </div>
                                            ...
                                            <ul class="mega-menu full-mega-menu">
                                                <li>
                                                    <div class="container">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <img src="<?=base_url('public/front_assets/assets/images/menu-banner.jpg');?>"
                                ...
                                <div class="icon-nav">
                                    <ul>
                                        <li class="onhover-div mobile-search">
                                            <div><img src="<?=base_url('public/front_assets/assets/images/icon/layout4/search.png');?>"
                                        ...
                                        <li class="onhover-div mobile-setting">
                                            <div><img src="<?=base_url('public/front_assets/assets/images/icon/layout4/setting.png');?>"
                                        ...
                                        <li class="onhover-div mobile-cart">
                                            <div href="javascript:void(0)" onclick="openCart()"><img
                                                    src="<?=base_url('public/front_assets/assets/images/icon/layout4/cart.png');?>"
                                                    class="img-fluid blur-up lazyload" alt=""> <i
        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home text-start p-left">
                    <img src="<?=base_url('public/front_assets/assets/images/home-banner/9.jpg');?>" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
                                        <h4>every time</h4>
                                        <h1>mittnalier</h1><a href="#" class="btn btn-outline btn-classic">shop now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div>
                <div class="home text-start p-left">
                    <img src="<?=base_url('public/front_assets/assets/images/home-banner/10.jpg');?>" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                    ...
                    <div class="slide-6 no-arrow">
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/logos/1.png');?>" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/logos/2.png');?>" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/logos/3.png');?>" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/logos/4.png');?>" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/logos/5.png');?>" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/logos/6.png');?>" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/logos/7.png');?>" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="<?=base_url('public/front_assets/assets/images/logos/8.png');?>" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="slide-4 category-m no-arrow">
                        <div>
                            <div class="category-wrapper">
                                <div>
                                    <div>
                                        <img src="<?=base_url('public/front_assets/assets/images/watch/cat1.png');?>"
                        ...
                        <div>
                            <div class="category-wrapper">
                                <div>
                                    <div>
                                        <img src="<?=base_url('public/front_assets/assets/images/watch/cat2.png');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                        ...
                        <div class="category-wrapper">
                            <div>
                                <div>
                                    <img src="<?=base_url('public/front_assets/assets/images/watch/cat3.png');?>" class="img-fluid blur-up lazyload bg-img"
                                        alt="">
                                </div>
                        ...
                        <div class="category-wrapper">
                            <div>
                                <div>
                                    <img src="<?=base_url('public/front_assets/assets/images/watch/cat2.png');?>" class="img-fluid blur-up lazyload bg-img"
                                        alt="">
                                </div>
                        ...
                        <div class="category-wrapper">
                            <div>
                                <div>
                                    <img src="<?=base_url('public/front_assets/assets/images/watch/cat1.png');?>" class="img-fluid blur-up lazyload bg-img"
                                        alt="">
                                </div>
                                <h4>watch models</h4>
                                <ul class="category-link">
                    ...
                    <div class="col">
                        ...
                        <div class="theme-tab">
                            <ul class="tabs tab-title">
                                <li class="current"><a href="tab-7.html">unisex watches</a></li>
                                <li class=""><a href="tab-8.html">couple watches</a></li>
                                <li class=""><a href="tab-9.html">titanium watches</a></li>
                                <li class=""><a href="tab-10.html">gold watches</a></li>
                            </ul>
                            <div class="tab-content-cls">
                                            ...
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            ...
                                                            src="<?=base_url('public/front_assets/assets/images/pro2/7.jpg');?>" alt=""></a>
                                                    <div class="media-body align-self-center">
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="<?=base_url('public/front_assets/assets/images/pro2/14.jpg');?>" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="<?=base_url('public/front_assets/assets/images/pro2/21.jpg');?>" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="<?=base_url('public/front_assets/assets/images/pro2/33.jpg');?>" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="<?=base_url('public/front_assets/assets/images/pro2/43.jpg');?>" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="<?=base_url('public/front_assets/assets/images/pro2/44.jpg');?>" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="<?=base_url('public/front_assets/assets/images/pro2/45.jpg');?>" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="<?=base_url('public/front_assets/assets/images/pro2/51.jpg');?>" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                ...
                <div class="col">
                    ...
                    <div class="product-4 product-m no-arrow">
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="lable-block"><span class="lable3">new</span> <span class="lable4">on
                                        sale</span></div>
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="<?=base_url('public/front_assets/assets/images/pro2/7.jpg');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="<?=base_url('public/front_assets/assets/images/pro2/6.jpg');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box">
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="<?=base_url('public/front_assets/assets/images/pro2/21.jpg');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="<?=base_url('public/front_assets/assets/images/pro2/22.jpg');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box">
                                    <button onclick="openCart()" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="<?=base_url('public/front_assets/assets/images/pro2/33.jpg');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="<?=base_url('public/front_assets/assets/images/pro2/34.jpg');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box">
                                    <button onclick="openCart()" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="<?=base_url('public/front_assets/assets/images/pro2/51.jpg');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="<?=base_url('public/front_assets/assets/images/pro2/50.jpg');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box">
                                    <button onclick="openCart()" title="Add to cart"><i
    ...
    <section class="section-b-space">
        <div class="full-box">
            <div class="container">
                <div class="title4">
                    <h2 class="title-inner4">Pocket Friendly Watch For men and women</h2>
                    <div class="line"><span></span></div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                                ...
                                <div>
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="<?=base_url('public/front_assets/assets/images/pro2/7.jpg');?>"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="<?=base_url('public/front_assets/assets/images/pro2/6.jpg');?>"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                            </div>
                                            <div class="cart-box">
                                                <button onclick="openCart()" title="Add to cart"><i
                    ...
                    <div class="slide-3 no-arrow">
                        <div>
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="<?=base_url('public/front_assets/assets/images/blog/layout4/1.jpg');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="<?=base_url('public/front_assets/assets/images/blog/layout4/2.jpg');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="<?=base_url('public/front_assets/assets/images/blog/layout4/3.jpg');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="<?=base_url('public/front_assets/assets/images/blog/layout4/4.jpg');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="<?=base_url('public/front_assets/assets/images/blog/layout4/5.jpg');?>"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="slide-5 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="<?=base_url('public/front_assets/assets/images/slider/watches/1.jpg');?>"
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="<?=base_url('public/front_assets/assets/images/slider/watches/2.jpg');?>" alt="Avatar"
                                        class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="<?=base_url('public/front_assets/assets/images/slider/watches/3.jpg');?>" alt="Avatar"
                                        class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="<?=base_url('public/front_assets/assets/images/slider/watches/4.jpg');?>" alt="Avatar"
                                        class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="<?=base_url('public/front_assets/assets/images/slider/watches/5.jpg');?>" alt="Avatar"
                                        class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="<?=base_url('public/front_assets/assets/images/slider/watches/6.jpg');?>" alt="Avatar"
                                        class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="<?=base_url('public/front_assets/assets/images/slider/watches/7.jpg');?>" alt="Avatar"
                                        class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="<?=base_url('public/front_assets/assets/images/slider/watches/8.jpg');?>" alt="Avatar"
                                        class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                ...
                <div class="row footer-theme partition-f">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="footer-contant">
                            <div class="footer-logo"><img src="<?=base_url('public/front_assets/logo2.png');?>" alt="" width="200px">
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="payment-card-bottom">
                            <ul>
                                <li>
                                    <a href="#"><img src="<?=base_url('public/front_assets/assets/images/icon/visa.png');?>" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?=base_url('public/front_assets/assets/images/icon/mastercard.png');?>" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?=base_url('public/front_assets/assets/images/icon/paypal.png');?>" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?=base_url('public/front_assets/assets/images/icon/american-express.png');?>" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?=base_url('public/front_assets/assets/images/icon/discover.png');?>" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="cart_media">
                <ul class="cart_product">
                    <li>
                        <div class="media">
                            <a href="#">
                                <img alt="" class="me-3" src="<?=base_url('public/front_assets/assets/images/pro2/43.jpg');?>">
                            </a>
                    ...
                    <li>
                        <div class="media">
                            <a href="#">
                                <img alt="" class="me-3" src="<?=base_url('public/front_assets/assets/images/pro2/44.jpg');?>">
                            </a>
                            <div class="media-body">
                                <a href="#">
                                    <h4>item name</h4>
                    ...
                    <li>
                        <div class="media">
                            <a href="#"><img alt="" class="me-3" src="<?=base_url('public/front_assets/assets/images/pro2/7.jpg');?>"></a>
                            <div class="media-body">
                                <a href="#">
                                    <h4>item name</h4>
                                </a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="modal-bg">
                                    ...
                                    <div class="offer-content"><img src="<?=base_url('public/front_assets/assets/images/Offer-banner.png');?>"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-12">
                            <div class="quick-view-img"><img src="<?=base_url('public/front_assets/assets/images/pro3/1.jpg');?>" alt=""
    ...
    <div class="theme-settings">
        <ul>
            ...
            <li class="input-picker">
                <input id="ColorPicker1" type="color" value="#e4604a" name="Background">
            </li>
        </ul>
    </div>
            ...
            <div class="setting_box_body">
                ...
                <div class="setting-body">
                    <div class="setting-title">
                        <div>
                            <img src="<?=base_url('public/front_assets/assets/images/icon/logo.png');?>" class="img-fluid" alt="">
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="gradient.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/gradient.jpg');?>"
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="index.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/fashion.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-2.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/fashion-2.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-3.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/fashion-3.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-4.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/fashion-4.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-5.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/fashion-5.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-6.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/fashion-6.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-7.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/fashion-7.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="furniture.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/furniture.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="furniture-2.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/furniture-2.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="furniture-3.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/furniture-dark.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="electronic-1.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/electronics.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="electronic-2.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/electronics-2.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="electronic-3.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/electronics-3.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marketplace-demo.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/marketplace.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marketplace-demo-2.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/marketplace-2.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marketplace-demo-3.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/marketplace-3.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marketplace-demo-4.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/marketplace-4.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="vegetables.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/vegetables.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="vegetables-2.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/vegetables-2.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="vegetables-3.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/vegetables-3.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="jewellery.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/jewellery.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="jewellery-2.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/jewellery-2.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="jewellery-3.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/jewellery-3.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="bags.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/bag.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="watch.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/watch.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="medical.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/medical.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="perfume.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/perfume.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="yoga.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/yoga.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="christmas.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/christmas.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="bicycle.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/bicycle.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marijuana.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/marijuana.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="gym-product.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/gym.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="tools.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/tools.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="shoes.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/shoes.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="books.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/books.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="kids.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/kids.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="game.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/game.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="beauty.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/beauty.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="left_sidebar-demo.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/left-sidebar.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="video-slider.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/video-slider.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="metro.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/metro.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="goggles.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/goggles.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="flower.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/flower.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="light.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/light.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="nursery.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/nursery.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="pets.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/pets.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="video.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/video.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="lookbook-demo.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/lookbook.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="full-page.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/full-page.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="instagram-shop.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/instagram.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="parallax.html" class="layout-container">
                                        <img src="<?=base_url('public/front_assets/assets/images/landing-page/demo/parallax.jpg');?>"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                                    ...
                                    <div class="media">
                                        <a href="#">
                                            <img class="img-fluid blur-up lazyload pro-img"
                                                src="<?=base_url('public/front_assets/assets/images/fashion/product/43.jpg');?>" alt="">
                                        </a>
                                        <div class="media-body align-self-center text-center">
                                            ...
                                            <div class="upsell_payment">
                                                <img src="<?=base_url('public/front_assets/assets/images/payment_cart.png');?>"
                                                    class="img-fluid blur-up lazyload" alt="">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row" id="upsell_product">
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                            <img src="<?=base_url('public/front_assets/assets/images/fashion/product/1.jpg');?>"
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                           <img src="<?=base_url('public/front_assets/assets/images/fashion/product/34.jpg');?>"
                                                                class="img-fluid blur-up lazyload mb-1"
                                                                alt="cotton top">
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                           <img src="<?=base_url('public/front_assets/assets/images/fashion/product/13.jpg');?>"
                                                                class="img-fluid blur-up lazyload mb-1"
                                                                alt="cotton top">
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                          <img src="<?=base_url('public/front_assets/assets/images/fashion/product/19.jpg');?>"
                                                                class="img-fluid blur-up lazyload mb-1"
                                                                alt="cotton top">
                                                        </a>
                                                    </div>
