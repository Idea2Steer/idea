                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="top-banner-wrapper">
                                        <a href="#"><img src="<?=base_url('public/front_assets/assets/images/mega-menu/2.jpg');?>"
                                                ...
                                                <div class="col-12">
                                                    <div class="product-filter-content">
                                                        ...
                                                        <div class="collection-grid-view">
                                                            <ul>
                                                                <li><img src="<?=base_url('public/front_assets/assets/images/icon/2.png');?>" alt=""
                                                                        class="product-2-layout-view"></li>
                                                                <li><img src="<?=base_url('public/front_assets/assets/images/icon/3.png');?>" alt=""
                                                                        class="product-3-layout-view"></li>
                                                                <li><img src="<?=base_url('public/front_assets/assets/images/icon/4.png');?>" alt=""
                                                                        class="product-4-layout-view"></li>
                                                                <li><img src="<?=base_url('public/front_assets/assets/images/icon/6.png');?>" alt=""
