<div class="col-sm-3 collection-filter">
                        ...
                        <div class="theme-card">
                            ...
                            <div class="offer-slider slide-1">
                                <div>
                                    <div class="media">
                                        <a href="#"><img class="img-fluid blur-up lazyload"
                                                src="<?=base_url('public/front_assets/assets/images/fashion/pro/1.jpg')?>" alt=""></a>
                                    ...
                                    <div class="media">
                                        <a href="#"><img class="img-fluid blur-up lazyload"
                                                src="<?=base_url('public/front_assets/assets/images/fashion/pro/011.jpg')?>" alt=""></a>
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i></div><a
                                    ...
                                    <div class="media">
                                        <a href="#"><img class="img-fluid blur-up lazyload"
                                                src="<?=base_url('public/front_assets/assets/images/fashion/pro/16.jpg')?>" alt=""></a>
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i></div><a
                                ...
                                <div>
                                    <div class="media">
                                        <a href="#"><img class="img-fluid blur-up lazyload"
                                                src="<?=base_url('public/front_assets/assets/images/fashion/pro/001.jpg')?>" alt=""></a>
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i></div><a
                                    ...
                                    <div class="media">
                                        <a href="#"><img class="img-fluid blur-up lazyload"
                                                src="<?=base_url('public/front_assets/assets/images/fashion/pro/4.jpg')?>" alt=""></a>
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i></div><a
                                    ...
                                    <div class="media">
                                        <a href="#"><img class="img-fluid blur-up lazyload"
                                                src="<?=base_url('public/front_assets/assets/images/fashion/pro/19.jpg');?>" alt=""></a>
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i></div><a
                        ...
                        <div class="collection-sidebar-banner">
                            <a href="#"><img src="<?=base_url('public/front_assets/assets/images/side-banner.png');?>" class="img-fluid blur-up lazyload"
                                    alt=""></a>
                        </div>
