              ...
              <div class="col-xl-12">
                  <div class="card custom_card">
                      <div class="card-body" >
                        <div class="row">
                           <div class="col-xl-12">
                            <h4>Sent reset password link</h4>
                           </div>
                        </div>      
                        <div class="row mt-1 mb-3">
                           <div class="col-xl-12">
                                <p>We have received your change password request. We’ve emailed you a password-reset link to your specified email address. The link is valid for 24 hours.</p>
                                <p>If you do not receive a  email, please check your spam folder. Also, please verify that you entered a valid email address in our form.</p>
